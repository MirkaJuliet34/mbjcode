...
export const aboutData = [
  {
    ...
    info: [
      ...
      {
        title: 'Backend',
        icons: [<FaNodeJs />, <SiMysql />, <SiPostgresql />],
      },
    ],
  },
  {
    ...
    info: [
      ...
      {
        title: 'Systems Analysis and Development - Concluded',
        stage: '2016-2022',
      },
    ],
  },
  {
    ...
    info: [
      {
        title: 'Developer / Monitor - Fundação Estudar',
        stage: '2023',
      },
      {
        title: 'Frontend Developer - MB Labs',
        stage: '2022 - 2023',
      },
      {
        title: 'Operations Specialist - Lumen Technologies',
        stage: '2018 - 2021',
      },
      {
        title: 'Network Support - ANTT',
        stage: '2016 - 2018',
      },
  ...
  },
  {
    ...
    info: [
      {
        title: 'Santander Bootcamp 2023 - Fullstack Java+Angular - DIO',
        stage: '2023',
      },
      {
        title: 'Potência Tech iFood - Programação do Zero - DIO',
        stage: '2023',
      },
      {
        title: 'Bootcamp Cloud AWS - DIO',
        stage: '2023',
      },
    ],
  },
      ...
      gap-x-6'>
        ...
        <div className='flex-1 flex flex-col justify-center'>
          ...
          <motion.p 
            ...
            >
              10 years ago, I started freelancing as a developer. Since then, 
              I've done remote work, provided services for startups and 
              collaborated on platform development.
          </motion.p>
          {/* counters */}
          <motion.div 
